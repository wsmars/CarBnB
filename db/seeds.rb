...
Car.create!(make: 'BMW', model: 'M3', year: 2015, milage: 5000, price: 200.00,
            ...
            img_url: 'http://res.cloudinary.com/dvy2aua0n/image/upload/c_scale,w_900/v1457342455/2015_bmw_m3_lfnjuj.jpg', lat: 37.7914342802915, lng: -122.3932548197085)
...
Car.create!(make: 'Honda', model: 'Civic si', year: 2012, milage: 25000, price: 50.00,
            ...
            user_id: 2, img_url: 'http://res.cloudinary.com/dvy2aua0n/image/upload/c_scale,w_900/v1457342455/2012_honda_civic_si_zakbzp.jpg', lat: 37.321967, lng: -122.013783)
...
Car.create!(make: 'Nissan', model: 'Murano', year: 2014, milage: 15000, price: 100.00,
            ...
            user_id: 3, img_url: 'http://res.cloudinary.com/dvy2aua0n/image/upload/c_scale,w_900/v1457342455/2014_nissan_murano_mlkr1f.jpg', lat:  37.79118408029149,
...
Car.create!(make: 'Audi', model: 'A8', year: 2016, milage: 3000, price: 300.00,
            ...
            user_id: 4, img_url: 'http://res.cloudinary.com/dvy2aua0n/image/upload/c_scale,w_900/v1457342457/2016_audi_a8_drveeu.jpg', lat: 37.790667 , lng: -122.396668)
...
Car.create!(make: 'Mecedes-Benz', model: 'GLA', year: 2015, milage: 15000, price: 120.00,
            ...
            user_id: 1, img_url: 'http://res.cloudinary.com/dvy2aua0n/image/upload/c_scale,w_900/v1457342455/2015_mercedes_benz_gla_ft7rtm.jpg', lat: 37.322040, lng: -122.010506)
...
Car.create!(make: 'VW', model: 'GTI', year: 2015, milage: 15000, price: 70.00,
            ...
            user_id: 2, img_url: 'http://res.cloudinary.com/dvy2aua0n/image/upload/c_scale,w_900/v1457342455/2015_vw_gti_qggg1y.jpg', lat: 37.792473, lng: -122.397612)
